...
def make_test_data(conn, name, meter_type, unit, volume, random_min,
    ...
    while timestamp <= end:
        ...
        print("INSERT INTO sample (meter_id, user_id, project_id, resource_id, resource_metadata, "
              "volume, timestamp, recorded_at, message_signature, message_id, source_id) "
              "VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');" % 
              (169L, 'usr123', 'proj123', random.choice(resource_ids), '{}', total_volume, timestamp, 
              datetime.datetime.now(), '6bbcaf2ad4389bd63a93ac34aef66492928acb4e84fbb6529c11daac2ce472fc', 
